...
scope_lb = torch.full((5,), -10.0)
scope_ub = torch.full((5,), 10.0)
...
for i in range(bo_iter):
    ...
    gp.eval()
    likelihood.eval()
    next_x, starting_candidate, ending_candidate = mes.find_next_point(3, dimension, scope_lb, scope_ub, gp, likelihood)
