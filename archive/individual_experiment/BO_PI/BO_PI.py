...
for i in range(bo_iter):
    ...
    gp.eval()
    likelihood.eval()
    next_x, starting_candidate, ending_candidate = pi.find_next_point(3, dimension, scope_lb, scope_ub, gp, likelihood)
    ...
    if dimension == 1:
        ...
        visual.aquisition_plotting_1D(pi, gp, likelihood, scope_lb, scope_ub, next_x, starting_candidate, ending_candidate)
