...
#scope_lb = torch.tensor([-1, -1])
#scope_ub = torch.tensor([1, 1])
...
for i in range(bo_iter):
    ...
    gp.eval()
    likelihood.eval()
    next_x = lcb.find_next_point(3, dimension, scope_lb, scope_ub, gp, likelihood)
    ...
    visual.GP_plotting(dimension, gp, likelihood, train_x, train_y, test_x, test_y, objective_function, scope_lb, scope_ub)
